...
**단계**: 핵심 구현과 Android 실제 기기 20웨이브 검증 완료. 선택 Polish 1·5·6번의 추가 스폰 겹침 회귀 수정 및 빌드 완료, Android 실기기 재검증 대기. 선택 Polish 7번은 구현 및 실기기 검증까지 완료.
...
**진행 중**
- [ ] 치명타 텍스트, 아이스볼 직접 빙결·근접 정지, 스폰 겹침 방지, 몬스터 바닥 공격 연출 Android 실기기 재검증
