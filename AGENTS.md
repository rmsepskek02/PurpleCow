...
| `HH-MM_Inspector연결및에디터수정` | X | O | 에디터 스크립트 버그 수정 2건(BallSetupEditor _maxBounces 누락, SceneSetupEditor DamageTextManager 중복), Inspector 참조 연결 4건(Ball.prefab, Monster 프리팹 4종, WaveManager, DamageTextManager) |
